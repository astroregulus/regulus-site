export default function MenuCelular({menuAberto, aoFechar}) {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
        ...
        <div className="mt-6">
          <nav className="grid gap-y-8">
            <a href="./turmas.html" target="_blank" rel="noopener noreferrer" className="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
            ...
            <a href="#livraria" className="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
            ...
            <a href="#formacao" className="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
      ...
      <div className="space-y-6 py-6 px-5">
        <div className="grid grid-cols-2 gap-y-4 gap-x-8">
          <a href="https://www.regulus.com.br/softwares/pegasus.htm" target="_blank" rel="noopener noreferrer" className="text-base font-medium text-gray-900 hover:text-gray-700">Software</a>

          <a href="#" className="text-base font-medium text-gray-900 hover:text-gray-700">Professores</a>

          <a href="#" className="text-base font-medium text-gray-900 hover:text-gray-700">Serviços</a>
        ...
        <div>
          <p className="mt-6 text-center text-base font-medium text-gray-500">
            Já é aluno?
            <a href="https://www.regulus.com.br/moodle" target="_blank" rel="noopener noreferrer" className="text-blue-regulus hover:text-indigo-500">Acesse a plataforma</a>
          </p>
        </div>
      </div>
    </div>
